...
that, if $\cong \Con \<A,F\>$ is a minimal representation of $L$,
...
in~\cite{HeitzigReinhold2002} and refined by Jipsen
...
find representations. Let $X_k = \{0, 1, \ldots, k-1\}$.
In most cases the minimal representation was found using 
our first algorithm, the closure algorithm.
...
\subsection{Lattices of size at most 7}
