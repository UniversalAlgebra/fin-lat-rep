...
then, up to isomorphism, $\bA \le \bA/\theta_0 \times \bA/\theta_1$. 
Thus 
any polymorph of $L'$ is determined by a polymorph of $\theta_0$ and
one of $\theta_1$. This cuts the search space from $k^k$ down 
to $r^r + s^s$, where $r$ and $s$ are the number of blocks in 
$\theta_0$ and~$\theta_1$.
\item
