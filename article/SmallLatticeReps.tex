...
%% (we could probably make the creation of diagrams simpler with some macros like:
%% \newcommand\nodedef[3]{\node (#1) at (#2,#3) [draw,circle,inner sep=\dotsize]{};}
...
\begin{center}
  \begin{tikzpicture}[scale=.4]
    ...
    \node (theta) at (0,3.5)  [draw,circle,inner sep=\dotsize] {};
