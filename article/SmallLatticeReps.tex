...
range; and \code{pentagonSearch.g} settles the present claim directly, by
examining every group $G$ with $|G| \leq 216$ together with every
core-free subgroup $H \leq G$, and finding that \code{SmallGroup(216,153)}
...
upper interval.  It examines every group of order at most 216 and every
core-free subgroup of each, and finds exactly one such group; that group
has twelve such subgroups $H$, forming a single conjugacy class, each
cyclic of order 6 and so of index 36.
\item
