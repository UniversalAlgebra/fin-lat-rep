...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% I. Generation of Bibliography File
%% ----------------------------------
...
%% II. Preamble
%% ------------
\documentclass[final,3p,12pt]{au}
\usepackage{enumerate,amsmath,amssymb,fancyhdr,mathrsfs,amsthm,url,stmaryrd,scalefnt,color,xspace}
\usepackage{tikz}
% \usetikzlibrary{calc}
\usepackage{ifthen}
