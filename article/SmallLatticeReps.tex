...
For obvious reasons, we take the \defn{size} of a group representation to be
the index $[G:H]$. Group representations are rarely unique, but occasionally
they are unique up to isomorphism.\footnote{For example, if $\lb H, G\rb$ is a
  group representation of the subgroup lattice of $A_4$, then $H$ is normal in
  $G$ and $G/H \cong A_4$.}
