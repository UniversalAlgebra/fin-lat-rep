...
a group with 216 elements.  That search was made with the function
\code{findUpperIntervals} of~\cite{finlatrepgap}, which looks through
the Small Groups Library of \gap, and its libraries of transitive and
of primitive groups, for upper intervals of a prescribed size.  It is easy
...
Section~\ref{sec:intro} that \code{SmallGroup(216,153)} is the smallest
group having $N_5$ as an upper interval.
\item
